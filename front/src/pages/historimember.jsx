<<<<<<< HEAD:front/src/pages/historimember.jsx
                        ...
                        <div className="flex flex-col justify-start items-start bg-zinc-100 px-4 py-4 md:py-6 md:p-6 xl:p-8 w-full rounded-xl">
                            ...
                            <div className="mt-4 md:mt-6 flex  flex-col md:flex-row justify-start items-start md:items-center md:space-x-6 xl:space-x-8 w-full">
                                <div className="pb-4 md:pb-8 w-full md:w-40">
                                    <img className="w-full hidden md:block" src="https://img.okezone.com/content/2019/06/19/298/2068239/bisa-buat-bekal-ngantor-ini-cara-buat-roti-panggang-cokelat-keju-NjZzlk07fz.jpg" alt="dress" />
                                    <img className="w-full md:hidden" src="https://i.ibb.co/L039qbN/Rectangle-10.png" alt="dress" />
                                </div>
                                <div className="border-b border-gray-200 md:flex-row flex-col flex justify-between items-start w-full  pb-8 space-y-4 md:space-y-0">
                                    <div className="w-full flex flex-col justify-start items-start space-y-8">
                                        <h3 className="text-xl xl:text-2xl font-semibold leading-6 text-gray-800">Roti Bakar Coklat</h3>
                                    ...
                                    <div className="flex justify-between space-x-8 items-start w-full">
                                        <p className="text-base xl:text-lg leading-6">
                                            Rp17.000 <span className="text-red-300 line-through"> Rp25.000</span>
                                        </p>
                                        <p className="text-base xl:text-lg leading-6 text-gray-800">x1</p>
                                        <p className="text-base xl:text-lg font-semibold leading-6 text-gray-800">Rp17.000</p>
                                    </div>
                                </div>
                            </div>
                            <div className="mt-6 md:mt-0 flex justify-start flex-col md:flex-row  items-start md:items-center space-y-4  md:space-x-6 xl:space-x-8 w-full ">
                                <div className="w-full md:w-40">
                                    <img className="w-full hidden md:block" src="https://akcdn.detik.net.id/api/wm/2020/06/18/spaghetti-carbonara_169.jpeg" alt="dress" />
                                    <img className="w-full md:hidden" src="https://i.ibb.co/BwYWJbJ/Rectangle-10.png" alt="dress" />
                                </div>
                                <div className="  flex justify-between items-start w-full flex-col md:flex-row space-y-4 md:space-y-0  ">
                                    <div className="w-full flex flex-col justify-start items-start space-y-8">
                                        <h3 className="text-xl xl:text-2xl font-semibold leading-6 text-gray-800">Spaghetti Carbonara</h3>
                                        <div className="flex justify-start items-start flex-col space-y-2">
                                            <p className="text-sm leading-none text-gray-800">
                                                <span className="text-gray-300">Style: </span> Italic Minimal Design
                                            </p>
                                    ...
                                    <div className="flex justify-between space-x-8 items-start w-full">
                                        <p className="text-base xl:text-lg leading-6">
                                            Rp38.000 <span className="text-red-300 line-through"> Rp40.000</span>
                                        </p>
                                        <p className="text-base xl:text-lg leading-6 text-gray-800">x1</p>
                                        <p className="text-base xl:text-lg font-semibold leading-6 text-gray-800">Rp38.000</p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
>>>>>>> Nida:front/src/pages/histori.jsx
                </div>
            </div>
        </div>
    );
